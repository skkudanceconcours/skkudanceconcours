...
const EditModal2026 = ({ isOpen, reception, onClose, onSave }: Props): ReactNode => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/50 lg:items-center lg:justify-center lg:p-4" onClick={onClose}>
      <div
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-x-8 lg:grid-cols-2">
          {/* 참가자 정보 */}
          <div>
            <p className="mb-2 font-semibold text-gray-600">참가자 정보</p>
            <NextTextInput
              label="참가자 이름"
              value={form.name}
          ...
          {/* 추가 정보 */}
          <div>
            <p className="mb-2 font-semibold text-gray-600">추가 정보</p>
            <NextTextInput
              label="학교명"
              value={form.school}
        ...
        {/* 전공 상세 */}
        <div className="mt-2">
          <p className="mb-2 font-semibold text-gray-600">전공 상세</p>
          <div className="grid grid-cols-1 gap-x-8 lg:grid-cols-2">
            <NextSelection
              label="전공 선택"
              options={majorOption}
