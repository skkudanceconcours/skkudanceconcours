...
export const gradeOption1:grade[] =[ '초등부 저학년(3,4학년)','초등부 고학년(5,6학년)','중등부 저학년(1,2학년)','중등부 고학년(3학년)','고등부 저학년(1,2학년)','고등부 고학년(3학년)','일반부']
//without '일반부'
export const gradeOption2:grade[] =[ '초등부 저학년(3,4학년)','초등부 고학년(5,6학년)','중등부 저학년(1,2학년)','중등부 고학년(3학년)','고등부 저학년(1,2학년)','고등부 고학년(3학년)']
//단체-한국무용/컨템포러리
export const gradeOption3:grade[] =[ '고등부','중등부','초등부(1,2학년 제외)'];
//단체-발레
export const gradeOption4:grade[] =[ '일반부','고등부','중등부','초등부(1,2학년 제외)'];
//한국무용
